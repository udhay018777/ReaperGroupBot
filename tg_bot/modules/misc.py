...
__help__ = """
 ...
 - /safemode <on/off/yes/no>: Restricts new users to send media for 24 hours after joining a group.
 ...
 - /paste Paste something at `neko.bin`
...
INFO_HANDLER = DisableAbleCommandHandler("whois", info, pass_args=True)
...
__mod_name__ = "☠️ Reaper Special ☠️"
