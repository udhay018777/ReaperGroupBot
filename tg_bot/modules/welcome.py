    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text("Whoa! My dev user just joined the chat. Everybody welcome him!!")
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text("Huh! That's one of my support users. Noice ☠️")
